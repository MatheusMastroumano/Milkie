                                ...
                                {listaCompras.map((item) => (
                                        ...
                                        <div className="border-t border-gray-300 pt-4">
                                            ...
                                            <div className="space-y-2">
                                                <button className="w-full px-4 py-3 text-sm font-medium text-[#FFFFFF] bg-[#2A4E73] rounded-md hover:bg-[#AD343E] focus:outline-none focus:ring-2 focus:ring-[#CFE8F9] transition-colors">
                                                    Finalizar Venda
                                                </button>
                                                <button 
